...
@WebServlet("/mobile")
public class fetchbymobile extends HttpServlet{
		...
		List<RegisterCreate> list = accessbyid.fetchmobile(mobile);
			
		if(list.isEmpty())
		{
			out.print("<h1> Data not found check the mobile number</h1>");
		}else {
